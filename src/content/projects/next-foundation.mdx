...
**Scalable**: I want the project to be scalable. The project is maintained by Pixel Perfect Agency and we want to be able to scale for large projects. Next foundation is not the source of truth for Pixel Perfect Agency, we apply things we learn from our projects to Next foundation.
