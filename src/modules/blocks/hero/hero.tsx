        ...
        <>
            ...
            <div className="relative mx-auto mt-32 flex max-w-7xl items-center gap-12">
                ...
                <div className="-skew-x-7 relative flex-1 rotate-4 skew-y-2 scale-75 lg:scale-100">
                    ...
                    <div className="relative ml-auto flex w-3/4 flex-col gap-3 rounded-2xl border border-neutral-200 bg-gradient-to-tr from-neutral-50 to-blue-500/5 p-2 shadow-lg backdrop-blur-3xl">
                        <Image
                        ...
                        />
                        <div className="hover:-translate-y-1 hover:-translate-x-1 absolute right-6 bottom-6 z-10 w-full overflow-hidden rounded-md bg-neutral-50 bg-weak p-3 shadow-[0_0_0_1px_#00000033,-4px_8px_8px_0_#00000022] transition duration-300 hover:shadow-[0_0_0_1px_#00000033,-6px_12px_16px_0_#00000022]">
